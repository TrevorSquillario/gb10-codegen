...
uvx llama-benchy --base-url http://localhost:8090/v1 --model stepfun-ai/Step-3.7-Flash-NVFP4 --enable-prefix-caching --latency-mode generation --depth 32768 --concurrency 1 2 4
